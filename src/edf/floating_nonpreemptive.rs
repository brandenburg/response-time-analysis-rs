...
/// Bound the maximum response time of a task under *earliest-deadline
/// first scheduling* with *floating nonpreemptive sections*
/// (**EDF-NPS**) on a dedicated, ideal uniprocessor.
///
...
/// 4. Jobs can be preempted at any point outside of critical sections.
/// 5. Jobs are nonpreemptive within critical sections.
/// 6. Critical sections may appear at any point during a job's execution.
/// 7. The maximum critical-section length is known *a priori*.
///
...
/// Refer to the [the Coq-verified instantiation](http://prosa.mpi-sws.org/branches/master/pretty/prosa.results.edf.rta.floating_nonpreemptive.html)
...
pub fn dedicated_uniproc_rta<RBF1, RBF2>(
    ...
    other_tasks: &[InterferingTask<RBF2>],
    limit: Duration,
